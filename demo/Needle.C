...
//    Integrator *i = new SimpsonIntegrator(7);
...
//   Stage *I1 = new Stage(W, 4, 1);
   Stage *I1 = new Stage(W, i, 16, 0.1, 2, 0.5);
   new Hermlet(I1, X, 0, 0);
   new Hermlet(I1, Y, 1, 0);
   new Hermlet(I1, Alpha, 8*M_PI/17, 8*M_PI/17);

//   Stage *I2 = new Stage(W, i, 4, 1);
   Stage *I2 = new Stage(W, i, 16, 0.1, 2, 0.3);
   new Hermlet(I2, X, 0, 0);
   new Hermlet(I2, Y, 0, -1);
   new Hermlet(I2, Alpha, 8*M_PI/17, 0);

   Stage *I3 = new Stage(W, i, 8, 0.1);
   new Hermlet(I3, X, -1, -1);
   new Constant(I3, Y, 0);
